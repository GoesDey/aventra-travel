            ...
            <form wire:submit.prevent="save" class="flex-1 overflow-hidden flex flex-col">
                <div class="p-6 overflow-y-auto flex-1 grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div class="lg:col-span-3 space-y-5">
                        ...
                        <div>
                            ...
                            <input id="pkg-image-{{ $iteration }}" wire:model="image" type="file" accept="image/*" class="block w-full text-sm text-outline file:mr-4 file:py-2.5 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-label-bold file:bg-surface-container-low file:text-oceanic-deep hover:file:bg-surface-container transition-all cursor-pointer">
                ...
                <div class="p-6 border-t border-outline-variant/30 bg-surface-container-lowest rounded-b-2xl flex justify-end gap-3 shrink-0">
                    ...
                    <button type="submit" wire:loading.attr="disabled" wire:target="image, save" class="px-6 py-2.5 rounded-full bg-tropical-teal hover:bg-oceanic-deep text-surface-white font-label-bold text-sm transition-colors shadow-sm flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed">
                        ...
                        <span wire:loading.remove wire:target="image">Save Package</span>
